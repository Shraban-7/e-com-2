...
@section('contents')
    ...
    <div class="bg-gray-50 border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 py-3 text-sm text-gray-600">
            <nav class="flex items-center space-x-2">
                <a href="/" class="hover:text-primary-600 font-medium">Home</a>
                <span>/</span>
                    ...
                    <div>
                        ...
                        @for ($i = 5; $i >= 1; $i--)
                            <label class="flex items-center gap-2 mb-1 cursor-pointer">
                                <input type="radio" name="rating" class="radio radio-sm radio-primary" />
            ...
            <section class="flex-1">
                ...
                <div class="flex justify-between items-center mb-4">
                    <button id="open-filter-btn" class="lg:hidden btn btn-sm btn-outline flex items-center gap-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 010 2H4a1 1 0 01-1-1zm3 4a1 1 0 011-1h10a1 1 0 010 2H7a1 1 0 01-1-1zm0 4a1 1 0 011-1h10a1 1 0 010 2H7a1 1 0 01-1-1zm0 4a1 1 0 011-1h10a1 1 0 010 2H7a1 1 0 01-1-1z" />
                        </svg>
                        Filters
                    </button>
                </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <p class="text-sm text-gray-600">Showing <span
                            class="font-medium text-gray-900">{{ count($products) }}</span> products</p>
                    <select class="select select-sm select-bordered w-full sm:w-52">
                ...
                <!-- Product Grid -->
                <div class="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
                        ...
                        <div
                            ...
                            <div class="p-3">
                                ...
                                <div class="flex items-center justify-between mt-3">
                                    ...
                                    <button class="btn btn-xs btn-outline">Add</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    <div id="filter-drawer" class="fixed inset-0 z-50 bg-black bg-opacity-50 hidden">
        <!-- Overlay for closing when clicking outside -->
        <div id="filter-overlay" class="absolute inset-0"></div>
        
        <!-- Drawer Content -->
        <div class="absolute inset-y-0 right-0 flex justify-end max-w-full">
            <div id="filter-panel" class="w-full xs:w-80 bg-white h-full p-5 transform transition-transform duration-300 ease-in-out translate-x-full overflow-y-auto">
